...
def dashboard():
    ...
    for r in grp:
        ...
        e["total"]+=n; e["completed"]+=r["completed"]; e["cancelled"]+=r["cancelled"]
        e["all_h"]+=h; e["all_d"]+=act
        if d==today_s: e["today_h"]+=h; e["today_d"]+=act; e["today_n"]+=n
        if d==yday_s:  e["yday_h"]+=h;  e["yday_d"]+=act;  e["yday_n"]+=n
        if week_s<=d<=today_s:      e["week_h"]+=h;  e["week_d"]+=act;  e["week_n"]+=n
        if month_s<=d<=today_s:     e["month_h"]+=h; e["month_d"]+=act; e["month_n"]+=n
        if lm_start_s<=d<=lm_end_s: e["lm_h"]+=h;    e["lm_d"]+=act;    e["lm_n"]+=n
